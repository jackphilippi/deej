...
# you can use 'deej.custom_match' to control all processes from a matching specified folder pattern, declared with 'custom_directory_match_regex'
...
custom_directory_match_regex: steamapps|Epic Games|EA Games|Riot Games|World of Warcraft|Wizards of the Coast 

# limits how often deej will look for new processes
# it's recommended to leave this setting at its default value (5)
